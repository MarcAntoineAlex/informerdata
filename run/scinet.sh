...
--name scinet --levels 3 --lr 3e-3 --batch_size 8 --dropout 0.5 --model SCINet --train_epochs 100 --patience 5
srun python main.py --data ETTh1 --features M  --seq_len 96 --label_len 48 --pred_len 48 --hidden-size 4 --stacks 1 \
--name scinet --levels 3 --lr 0.009 --batch_size 16 --dropout 0.25 --model SCINet --train_epochs 100 --patience 5
srun python main.py --data ETTh1 --features M  --seq_len 336 --label_len 168 --pred_len 168 --hidden-size 4 --stacks 1 \
--name scinet --model SCINet --train_epochs 100 --patience 5 --levels 3 --lr 5e-4 --batch_size 32 --dropout 0.5
srun python main.py --data ETTh1 --features M  --seq_len 336 --label_len 336 --pred_len 336 --hidden-size 1 --stacks 1 \
--name scinet --model SCINet --train_epochs 100 --patience 5 --levels 4 --lr 1e-4 --batch_size 512 --dropout 0.5
srun python main.py --data ETTh1 --features M  --seq_len 736 --label_len 720 --pred_len 720 --hidden-size 1 --stacks 1 \
--name scinet --model SCINet --train_epochs 100 --patience 5 --levels 5 --lr 5e-5 --batch_size 256 --dropout 0.5

srun python main.py --data ETTh1 --features M  --seq_len 96 --label_len 48 --pred_len 24 --hidden-size 4 --stacks 1 \
--name scinet --model SCINet --train_epochs 100 --patience 5 --levels 3 --lr 3e-3 --batch_size 8 --dropout 0.5
srun python main.py --data ETTh1 --features M  --seq_len 96 --label_len 48 --pred_len 48 --hidden-size 4 --stacks 1 \
--name scinet --model SCINet --train_epochs 100 -patience 5 --levels 3 --lr 0.009 --batch_size 16 --dropout 0.25
