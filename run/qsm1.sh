...
srun -u main.py --name qs --model qs --data ETTh2 --seq_len 96 --pred_len 24 --label_len 48 \
    --hidden_size 128 --n_heads 5 --e_layers 2 --encoder_attention "query_selector_0.5" --decoder_attention "full" \
    --d_layers 2 --batch_size 64 --embedding_size 48 --dropout 0.15 --features M --itr 3

srun -u main.py --name qs --model qs --data ETTh2 --seq_len 96 --pred_len 48 --label_len 48 \
    --hidden_size 144 --n_heads 5 --e_layers 2 --encoder_attention "query_selector_0.75" --decoder_attention "full" \
    --d_layers 2 --batch_size 144 --embedding_size 96 --dropout 0.1 --features M --itr 3
